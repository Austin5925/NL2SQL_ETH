...
dbUrl = os.getenv(
    "DB_URL",
    "mysql://root:111@localhost:3306/eth_data?charset=utf8&maxsize=20"
)
# "mysql://root:n22Qt4kSMZnG7FR@sc.tudb.work:4000/cars?charset=utf8mb4
# &maxsize=20")
# "mysql://tudb_ai:QP4NbGDyb6vc@car-data.mysql.polardb.rds.aliyuncs.com:3306/
# cars?charset=utf8mb4&maxsize=20")
...
#     """Least-recently-used cache decorator with time-based cache
#     invalidation.
#
#     Args:
...
#             return _new(*args, **kwargs, __time_salt=
